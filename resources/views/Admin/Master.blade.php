...
@php
    ...
    $url = request()->path();
    $parts = explode('/', $url);
    $name = Register_user::where('User_email',session('Aemail'))->first();
@endphp
                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarContent">
                        <ul class="navbar-nav mx-auto gap-0 gap-md-3">
                            <li class="nav-item">
                                <a class="nav-link @if($parts[0] == 'ahome') active @endif
                                ms-2 ms-md-0" href="{{ URL::to('/') }}/ahome"><i class="bi bi-house-fill"></i> Home</a>
                            </li>

                            <li class="nav-item">
                                <a class="nav-link @if($parts[0] == 'acontact') active @endif
                                ms-2 ms-md-0" href="{{ URL::to('/') }}/acontact"><i class="bi bi bi-headset"></i> Contact</a>
                            </li>
                            
                            <li class="nav-item">
                                <a class="nav-link @if($parts[0] == 'aproduct') active @endif
                                ms-2 ms-md-0" href="{{ URL::to('/') }}/aproduct"><i class="bi bi-cart-fill"></i> Product</a>
                            </li>
                            
                            <li class="nav-item">
                                <a class="nav-link @if($parts[0] == 'aorder') active @endif
                                ms-2 ms-md-0" href="{{ URL::to('/') }}/aorder"><i class="bi bi-box-fill"></i> Order</a>
                            </li>
                            
                            <li class="nav-item">
                                <a class="nav-link @if($parts[0] == 'auser') active @endif
                                ms-2 ms-md-0" href="{{ URL::to('/') }}/auser"><i class="bi bi-person-fill"></i> User</a>
                            </li>
                        </ul>

                        <ul class="navbar-nav icon gap-0 gap-md-2">
                            <li class="nav-item">
                                <a class="nav-link @if($parts[0] == '') active @endif 
                                ms-2 ms-md-0" href="{{ URL::to('/') }}/alogout_action"><i class="bi bi-box-arrow-in-right"></i> Logout</span></a>
                            </li>
                        </ul>
                    </div>
                </div>
